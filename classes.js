...
export class Particle {
  ...
  update(){
    ...
    this.x -= this.speedX;
    this.y += this.speedY;
   if ( this.y > this.game.height + this.size || this.x < 0 - this.size || this.y < 0 - this.size) this.markedForDeletion = true;
  }
  draw(context){            
...
export class Layer {
  ...
  draw(content){
    content.drawImage(this.image, this.x, this.y);
    content.drawImage(this.image, this.x + this.width, this.y);
  }
...
export class UI {
  ...
  draw(context){
    ...
    if(this.game.gameOver){
     ...
     //ammo
     if(this.game.player.powerUp)context.fillStyle = this.color = '#ffffbd';
